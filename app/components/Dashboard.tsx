          ...
          <Widget
            modalChildren={
              <p>
                ...
                EXPLAIN HOW THE TIMELAPSE IS FORMED - COMPOSITION OF IMAGES FROM
                THE INITIAL LAUNCH OF LANDSAT 5 TO THE MOST RECENT IMAGES FROM
                LANDSAT 8 SOURCED FROM GOOGLE EARTH ENGINE
              </p>
            }
          >
